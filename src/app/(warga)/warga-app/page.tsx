...
import { 
  ...
  Wallet, ArrowDownRight, ArrowUpRight, Receipt, Landmark, Image as ImageIcon, ExternalLink
} from 'lucide-react';
...
export default function WargaBerandaPage() {
  ...
  // State Modal Preview Nota/Bukti Pengeluaran
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // 3. Query data_warga (Telah disesuaikan dengan skema database asli)
        ...
        setProfile({
          ...
          rt: '01', // Default fallback karena tidak ada di DB
          rw: '01', // Default fallback karena tidak ada di DB
      ...
      <div className="space-y-3">
        ...
        {isLoading ? (
          ...
          pengumumanList.map((item) => (
            <div
              key={item.id}
              className={`p-4 bg-white rounded-2xl border shadow-sm space-y-2 ${
